      ...
      >
        <div className="glass-card rounded-[3.5rem] p-10 sm:p-16">
          <div className="text-center mb-14">
            ...
            <h1 className="text-fluid-3xl font-black text-[#1A1A2E] tracking-tighter leading-none mb-4">Initialize Account</h1>
            <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.4em] italic">Join the global rapid response network</p>
          </div>
          ...
          <div className="mt-14 pt-10 border-t border-slate-100 text-center">
            <p className="text-[11px] font-black text-slate-400 uppercase tracking-widest">
              ALREADY A MEMBER?{' '}
              <Link to="/login" className="text-blue-600 hover:text-blue-700 transition-all border-b-2 border-blue-600/10 hover:border-blue-600 ml-2">ACCESS TERMINAL</Link>
            </p>
          </div>
        </div>
        <p className="text-center text-[10px] font-black text-slate-300 uppercase tracking-[0.5em] mt-12">
          © 2026 ROADHELP CORP. SECURE ONBOARDING.
        </p>
      </motion.div>
    </div>
  );
