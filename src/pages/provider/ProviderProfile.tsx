      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto space-y-8 pb-20">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-100 pb-8">
          <div>
            ...
            <p className="text-slate-500 font-medium tracking-wide">Keep your business details and service list up to date.</p>
          </div>
              ...
              <div className="space-y-4 pt-6 border-t border-slate-50 text-left">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-slate-700">{profile?.businessAddress || 'Add your shop address'}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm p-8">
              <div className="flex items-center gap-2 mb-8">
                <div className="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600"><Save className="w-5 h-5" /></div>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="pt-6 border-t border-slate-50">
                  <Label className="ml-1 text-[10px] font-black uppercase tracking-widest text-slate-400 block mb-6">Available services</Label>
                  {isServicesLoading ? (
            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm p-8 flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                <h4 className="text-lg font-black text-slate-900 tracking-tight">Trust and security</h4>
